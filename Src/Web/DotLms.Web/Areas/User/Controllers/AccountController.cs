...
namespace DotLms.Web.Areas.User.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(DotLmsUserManager userManager, DotLmsSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Index", "CoursePresentation", new { Area = "" });
                }
                AddErrors(result);
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                Data.Models.User user = await UserManager.FindByNameAsync(model.Email);
