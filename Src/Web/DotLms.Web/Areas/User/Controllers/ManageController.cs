...
namespace DotLms.Web.Areas.User.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        private DotLmsSignInManager _signInManager;
        private DotLmsUserManager _userManager;

        public ManageController()
        {
        }

        public ManageController(DotLmsUserManager userManager, DotLmsSignInManager signInManager)
        {
        ...
        public DotLmsSignInManager SignInManager
        {
            get
            {
                return _signInManager ?? HttpContext.GetOwinContext().Get<DotLmsSignInManager>();
            }
            private set 
            { 
        ...
        public DotLmsUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<DotLmsUserManager>();
            }
            private set
            {
                _userManager = value;
        ...
        public async Task<ActionResult> RemoveLogin(string loginProvider, string providerKey)
        {
            ...
            if (result.Succeeded)
            {
                Data.Models.User user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
                if (user != null)
                {
...
#region Helpers
        ...
        {
            Data.Models.User user = UserManager.FindById(User.Identity.GetUserId());
            if (user != null)
            {
