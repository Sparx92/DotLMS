...
{
    public class AllCoursesCacheingInterceptor : IInterceptor
    {
        private IMemoryCacheProvider memoryCacheProvider;

        public AllCoursesCacheingInterceptor(IMemoryCacheProvider memoryCacheProvider)
        {
        ...
        {
            if (invocation.Request.Method.Name == "GetAllCourseViewModels")
            {
                string name = "AllCourses";
